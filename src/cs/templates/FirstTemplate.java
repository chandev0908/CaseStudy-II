...
public class FirstTemplate {
	public void sendMail(String subj, String msgContent, String recipient) {
		...
		try {
			...
			if (rs.next()) {
				myEmail = rs.getString("user_email");
				myPass = rs.getString("user_pass");
			} else {
				JOptionPane.showMessageDialog(null,
						"Email and password is required for sending email! You can go to profile to login your GMAIL account");
			}
		...
		String subject = subj;
		ConnectionDB dbs = new ConnectionDB();
		try {
